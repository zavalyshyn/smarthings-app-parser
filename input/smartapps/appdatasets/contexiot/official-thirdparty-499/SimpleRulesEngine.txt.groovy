...
def initialize() {
    ...
    subscribe(waterSensors, "water", handler, [filterEvents: false])
    subscribe(carbonMonoxideDetectors, "carbonMonoxide", handler, [filterEvents: false])
    subscribe(smokeDetectors, "smoke", handler, [filterEvents: false])
    subscribe(doorControls, "door", handler, [filterEvents: false])
